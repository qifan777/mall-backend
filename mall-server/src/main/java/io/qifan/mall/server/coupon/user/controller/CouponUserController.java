...
public class CouponUserController {
  ...
  @GetMapping("{id}")
  public @FetchBy(value = "COMPLEX_FETCHER", ownerType = CouponUserRepository.class) CouponUser findById(
      @PathVariable String id) {
    return couponUserService.findById(id);
  }

  @PostMapping("query")
  public Page<@FetchBy(value = "COMPLEX_FETCHER", ownerType = CouponUserRepository.class) CouponUser> query(
  ...
  public List<@FetchBy(value = "COMPLEX_FETCHER", ownerType = CouponUserRepository.class) CouponUser> listByIds(
      @RequestBody List<String> ids) {
    return couponUserService.listByIds(ids);
  }
}