...
public class DictConstants {
  ...
  public static final String AGENT_LEVEL_NAME = "AGENT_LEVEL_NAME";
  @Getter
  @AllArgsConstructor
  ...
  public enum AgentLevelName{
        FIRST(0, "1级", "FIRST", 1011, "代理等级", "AGENT_LEVEL_NAME", 0),
        SECOND(1, "2级", "SECOND", 1011, "代理等级", "AGENT_LEVEL_NAME", 0),
        THIRD(2, "3级", "THIRD", 1011, "代理等级", "AGENT_LEVEL_NAME", 0),
  ;
  final int keyId;
  final String keyName;
  final String keyEnName;
